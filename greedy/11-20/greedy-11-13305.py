...
N = int(input())
liter_of_between_two_cities = list(map(int, input().split()))
price_per_liter_of_city = list(map(int, input().split()))

current_city_price = price_per_liter_of_city[0]
total_price = 0
for i in range(N-1):
    if current_city_price > price_per_liter_of_city[i]:
        current_city_price = price_per_liter_of_city[i]
    total_price += current_city_price * liter_of_between_two_cities[i]
print(total_price)
