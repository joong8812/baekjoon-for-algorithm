...
for _ in range(T):
    ...
    applicants.sort()
    min_rank_of_second = applicants[0][1]
    for i in range(len(applicants)):
        next_applicant_rank_of_second = applicants[i][1]
        if next_applicant_rank_of_second < min_rank_of_second:
            min_rank_of_second = next_applicant_rank_of_second
            count_pass_candidates += 1
            
    print(count_pass_candidates)
