...
4
'''
type_of_money_list = [500, 100, 50, 10, 5, 1]
total_change = 1000 - int(input())
amount_of_change = 0
for money_type in type_of_money_list:
    amount_of_change += total_change // money_type
    total_change = total_change % money_type
