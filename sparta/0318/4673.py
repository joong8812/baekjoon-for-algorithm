...
def sum_by_myself(num):
    return num + (num//1000) + ((num//100)%10) + ((num//10)%10) + (num%10)
all_number = [0 for n in range(1, 10001)]

start_num = 1
while start_num < 10000:
    num_has_creater = sum_by_myself(start_num)
    if num_has_creater <= 10000:
        all_number[num_has_creater-1] = 1
    start_num+=1

for i, val in enumerate(all_number):
    if val == 0:
        print(i+1)